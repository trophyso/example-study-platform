...
import { CompletedAchievementResponse, EventResponse, StreakResponse } from '@trophyso/node/api';
 ...
 */
export async function getAchievements(): Promise<CompletedAchievementResponse[] | null> {
    try {
