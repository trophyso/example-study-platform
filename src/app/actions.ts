...
import { EventResponse, BaseAchievementResponse, StreakResponse } from '@trophyso/node/api';
 ...
 */
export async function getAchievements(userId: string): Promise<BaseAchievementResponse[] | null> {
    try {
